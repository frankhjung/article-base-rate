...
Rate of vaccinated in hospital is: `r round(vaccinated_hospitalisation_rate, 2)`
per 1,000 people.
...
- Unvaccinated are `r round(death_rate_ratio, 1)` times more likely to die from COVID-19.
